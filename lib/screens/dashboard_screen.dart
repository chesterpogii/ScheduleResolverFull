        ...
        child: Column(
          children: [
            ...
            if (sortedTasks.isNotEmpty)
              ElevatedButton(
                onPressed: aiService.isLoading ? null : () async {
                  print('Starting AI analysis...');
                  print('Tasks: ${scheduleProvider.task.length}');
                  await aiService.analyzeSchedule(scheduleProvider.task);
                  if (aiService.errorMessage != null) {
                    print('Error: ${aiService.errorMessage}');
                  }
                },
            ...
            if (aiService.errorMessage != null)
              Padding(
                ...
                child: Text('Error: ${aiService.errorMessage}', style: const TextStyle(color: Colors.red)),
              ),
          ],
        ),
      ),
